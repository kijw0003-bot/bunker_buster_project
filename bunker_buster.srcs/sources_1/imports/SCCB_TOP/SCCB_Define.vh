`define REG_GAIN        		8'h00    // Gain lower 8 bits (rest in vref)
...
`define REG_COM5        		8'h0E    // All "reserved"
`define REG_COM6        		8'h0F    // Control 6
`define REG_AECH        		8'h10    // More bits of AEC value
`define REG_CLKRC       		8'h11    // Clocl control
`define REG_COM7        		8'h12    // Control 7
...
`define REG_MIDH        		8'h1C    // Manuf. ID high
`define REG_MIDL        		8'h1D    // Manuf. ID low
...
`define REG_HREF        		8'h32    // HREF pieces
					//0x33-0x39
`define REG_TSLB        		8'h3A    // lots of stuff
...
`define REG_MTX_SIGN 			8'h58	// Matrix coefficient sign
					//0x59-0x66
`define REG_MANU				8'h67	//Manual U Value
`define REG_MANV				8'h68	//Manual V Value
...
`define REG_REG74				8'h74    // Digital gain control
`define REG_REG75				8'h75    // Edge enhancement lower
`define REG_REG76				8'h76    // Edge enhancement upper
`define REG_REG77				8'h77    // De-noise range
					//0x78-0x8B
