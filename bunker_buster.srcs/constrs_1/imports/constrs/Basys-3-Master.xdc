...
set_property -dict { PACKAGE_PIN B15 IOSTANDARD LVCMOS33  } [get_ports {RsRx_UI}]; # JB3    
set_property -dict { PACKAGE_PIN B16 IOSTANDARD LVCMOS33  } [get_ports {RsTx_UI}]; # JB4  
